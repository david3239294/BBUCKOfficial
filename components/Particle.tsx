  ...
  useEffect(() => {
    ...
    class Effect {
      ...
      init(ctx: CanvasRenderingContext2D) {
        ...
        this.img.src = '/images/logoo.png'; // Set the image source
          ...
          if (this.img.complete) {
            ...
            for (let y = 0; y < this.h; y += 3) {
              for (let x = 0; x < this.w; x += 3) {
                ...
                const green = 0; // Set green color value
                const blue = 0; // Set blue color value
                const alpha = 0; // Set alpha value
  ...
  return (
    <div>
      <div className="w-full h-full canvas-container">
        ...
        <Image src="/images/logoo.png" alt="avatar" width={0} height={0} />
      </div>
    </div>
  );
};
